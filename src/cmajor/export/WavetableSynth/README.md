### Auto-generated HTML & Javascript for Cmajor Patch "Wavetable Synth"
...
- `cmaj_Wavetable_Synth.js` - this is the Javascript wrapper class for the patch, encapsulating its
